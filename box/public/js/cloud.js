...
var cancel = document.getElementById('cancel_login');
...
var cloudLogin = function() {
    ...
    xhr.onloadend = function () {
        ...
        var currentUserDisplay = document.getElementById('login_logout');
...
cloudForm.addEventListener('click', cloudLogin);
cancel.addEventListener('click', bt.ui.hideLogin);
